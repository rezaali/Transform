...
void main()
{
    ...
    float offset = -2.0 * iAnimationTime * TWO_PI; 
    float x = radius * sin( norm * TWO_PI + offset ); 
    float z = radius * cos( norm * TWO_PI + offset );     
    float y = amplitude * sin( norm * TWO_PI * 4.0 + 10.0 * iAnimationTime * TWO_PI ); 
